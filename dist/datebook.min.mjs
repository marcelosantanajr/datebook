...
var URL = {
    ...
    OUTLOOK: 'https://outlook.{{host}}.com/calendar/deeplink/compose'
};
...
export { CalendarBase, GoogleCalendar, ICalendar, OutlookCalendar, YahooCalendar };
//# sourceMappingURL=datebook.min.mjs.map
